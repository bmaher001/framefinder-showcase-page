...
export default function ShowcaseDemo() {
 ...
 {step<4&&<div className="showcase-status"><span className="showcase-dot" aria-hidden="true"/><span>{['DEMO / Connect a source drive to begin','DRIVE IDENTIFIED / Archive North · FF-A7C2-91D4','INDEXING / Field Unit 03 · 68% · Example progress','DRIVE IDENTITY / Archive North · Catalogue details'][step]}</span></div>}
